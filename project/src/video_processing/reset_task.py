...
def parse_args():
    ...
    parser.add_argument("--no-downstream", action="store_true", help="Only reset the specified stage.")
    parser.add_argument("--reset-video-status", action="store_true", help="Also reset the video status to pending.")
